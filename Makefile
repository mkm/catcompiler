...
RUNTESTS=fib.test
COMPTESTS=pair.type.asm ackermann.type.asm logic.type.asm option.type.asm qsort.type.asm reverse.type.asm rwlist.type.asm treesort.type.asm tuple.type.asm equal.type.asm case.type.asm
